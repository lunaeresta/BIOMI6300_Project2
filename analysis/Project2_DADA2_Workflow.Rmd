...
# # Loading 1st metadata file and selecting 10 samples out 46 total from the paper
# metadata_1 <- read.csv("data/IDEO_eLife_revision_Extended_Data.txt")
# metadata_1_10samples <- metadata %>%
#   filter(SampleID %in% c("OB008","OB011","OB012","OB014","OB018","OB020","OB021","OB022","OB024","OB026"))
# # View(metadata_1_10samples)
# 
# # Loading 2nd metadata file
# metadata_2 <- read.csv("data/SraRunTable.txt")
# # View(metadata_2)
# 
# # Merging metadata files
# complete_metadata <- merge(metadata_1_10samples, metadata_2, by.x = "SampleID", by.y = "Sample.Name")
# # View(complete_metadata)
# 
# # Setting a variable with all the sample names by scanning our "samples" file
# samples <- complete_metadata$SampleID

# Use 4 samples first to test
...
# figaro asked to trim 163-forward and 147-reverse for this dataset. And trimleft at the 19th and 20th position.
