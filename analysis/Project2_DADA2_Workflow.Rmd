...
# 
# library("devtools")
# devtools::install_github("benjjneb/")
# packageVersion("dada2")
...
View(taxa[row.names(taxa) %in% names(mock_sample_sub), ]) # taxa that only matches the mock community, and we want all the columns!
